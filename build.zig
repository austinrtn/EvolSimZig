...
pub fn build(b: *std.Build) void {
    ...
    const mod = b.addModule("EvolSimZig", .{
    ...
    exe.root_module.addImport("ZigGridLib", spacial_grid.module("ZigGridLib"));
    ...
    exe.root_module.addImport("lua", luajit_build);
}
